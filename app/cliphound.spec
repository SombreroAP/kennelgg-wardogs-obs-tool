...
a = Analysis(
    ...
    hiddenimports=collect_submodules("obsws_python") + ["bridge", "capture_obs", "capture", "obs", "twitch", "setup", "colors", "ocr", "detector", "nearby", "vehicle", "twitch_device", "websocket", "voice", "inventory", "vosk", "faster_whisper", "ctranslate2", "tokenizers", "huggingface_hub", "onnxruntime", "av"] + extra_hidden,
    hookspath=[],
    runtime_hooks=[],
